...
Its purpose is to allow anyone unfamiliar with the project
(peers, staff, recruiters, etc.) to quickly understand what the project is about,
how to run it, and where to find more information on the topic.
...
(documentation, articles, tutorials, etc.), as well as a description of how AI was used —
