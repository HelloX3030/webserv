# http status codes — range [100, 599]

3-digit integers. 
range = total defined space per HTTP spec (RFC 9110, 2022).
...
culture — t-shirts, mugs, error pages. the clearest evidence that
standards are written by human beings.