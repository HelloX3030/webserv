...
a namespace is a bijective (or surjective) mapping between two domains:
...
to maintain the illusion of persistence and meaning in a system built on
...
binding operation:
- `bind` - create the mapping itself: associate name/address with socket
  entity
